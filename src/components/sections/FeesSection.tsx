              ...
              <table className="w-full text-sm" aria-label="Přehled správních poplatků">
                <thead>
                  <tr className="bg-[#f3f4f6]">
                    ...
                    <th
                      scope="col"
                      className="px-5 py-3 text-right text-xs font-semibold text-[#6b7280] uppercase tracking-wide"
                    >
                      Poplatek
                    </th>
                  </tr>
                ...
                return (
                  ...
                  >
                    {isGreen ? (
                      <CheckCircle2
                        size={17}
                        className="text-[#047857] mt-0.5 shrink-0"
                        aria-hidden="true"
                      />
                    ) : (
                      <AlertCircle
                    ...
                    <div>
                      ...
                      <p
                        className={`text-sm mt-0.5 font-semibold ${
                          isGreen ? "text-[#047857]" : "text-[#dc2626]"
                        }`}
                      >
                        {rule.consequence}
                      </p>
