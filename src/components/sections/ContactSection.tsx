...
// Embed built from their Google kgmid /g/11c5wq3q14 — Autoškola Jízda, Rakovník
const MAP_EMBED =
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <FadeIn direction="right">
            <div className="rounded-xl overflow-hidden border border-[#e5e7eb] shadow-sm h-full min-h-[360px]">
              <iframe
