...
export const TESTIMONIALS = [
  {
    id: 1,
    name: "Natálie Nováková",
    rating: 5,
    date: "2025-11",
    text: "Autoškola Jízda je prostě nejlepší! Pan instruktor byl vždy trpělivý, přátelský a skvěle mi vysvětlil vše potřebné. Díky jeho přístupu jsem složila zkoušky na první pokus. Doporučuji každému!",
    initials: "NN",
  },
  {
    id: 2,
    ...
    rating: 5,
    date: "2025-10",
    text: "Výborná autoškola, přátelský přístup instruktora. Zkoušky jsem udělal na první pokus. Rozhodně doporučuji!",
    initials: "MH",
  },
  {
    id: 3,
    ...
    rating: 5,
    date: "2025-09",
    text: "Moc děkuji za trpělivost a skvělý přístup. Teoretická výuka byla srozumitelná a praktické jízdy probíhaly v klidu bez stresu.",
    initials: "LD",
  },
  {
    id: 4,
    ...
    rating: 5,
    date: "2025-08",
    text: "Dokonalá autoškola! Instruktor je profesionál na 100 %. Jízdy probíhaly přesně a efektivně. Na zkoušce jsem byl naprosto připravený.",
    initials: "TB",
  },
  {
    id: 5,
    ...
    rating: 5,
    date: "2025-07",
    text: "Skvělý přístup, flexibilní termíny, příjemná atmosféra. Autoškola Jízda splnila všechna má očekávání a ještě víc.",
    initials: "EP",
  },
  {
    id: 6,
    ...
    rating: 5,
    date: "2025-06",
    text: "Kurz proběhl bez komplikací. Instruktor je zkušený, klidný a věděl jak mě motivovat i v těžších situacích. Vřele doporučuji.",
    initials: "JK",
  },
];
